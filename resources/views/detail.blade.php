...
<body>
    <div class="topnav">
        ...
        <div class="right-lnk">
            ...
            <a style="padding-top:25px;padding-right:20px " class="login-text" href="{{ route('logout') }}"
    ...
    <div style="margin-top:120px;" class="detailblock">

        <div class="shopping-card col-6">
            <div class="img-container">
                <img src="{{ URL::asset('img/brand.png') }}" alt="">
            </div>
        </div>
        <div class="col-6">
            <div>
                ...
                <div class="row">
                    <p class="price">5000 KS</p>
                </div>
                <div>
                    <p style="font-size: 13px;" >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente nemo eius labore doloribus,
                        nam rerum? Natus magnam praesentium qui nesciunt officia repudiandae, itaque ullam rerum eius
                        sapiente reprehenderit optio laboriosam.
                    <p>
                </div>
